...
public class ConfigureULDPForwarderForm extends AbstractFormBean implements Locators.UCForwardersPageLocator {
	
	
	@Randomizer(type = RandomizerTypes.MIXED, length = 8, prefix = "ULDP Auto")
	@FormElement(fieldType = Type.textbox, fieldLoc = FORWARDER_NAME_LOCATOR, required = true, order = 1)
	public String uldpForwarderName;
